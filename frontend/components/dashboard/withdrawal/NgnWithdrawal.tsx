      ...
      <div className="w-full h-auto p-[32px] bg-[linear-gradient(253.67deg,rgba(143,109,245,0.1)_18.27%,rgba(33,35,36,0.1)_91.93%)] border border-[#FBFBFB1F] gap-6 rounded-[19px] opacity-100 flex flex-col  items-start ">
        {accountNumber && bankName ? (
          <div className="flex flex-col gap-[16px]">
            <h1 className="text-[16px] font-[600px] text-[#8F6DF5] font-[Montserrat]">
              Account Details
            </h1>
            <div className="py-[16px] gap-[12px] relative px-[20px] rounded-[16px] border-[1px] border-[#8F6DF533] flex items-start w-fit">
              ...
              <div className="flex flex-col gap-[8px]">
                <div className="flex gap-[10px] items-center w-full justify-between">
                  <h1 className="text-[22px] font-[Inter] font-[500] text-[#FBFBFB]">
                    {accountNumber}
                  </h1>
                ...
                <div className="flex gap-[10px] items-center w-full justify-between">
                  <h1 className="text-[16px] font-[Inter] font-[500] text-[#FBFBFB]">
                    {bankName}
                  </h1>
                ...
                <div className="flex gap-[10px] items-center w-full justify-between">
                  <h1 className="text-[18px] font-[Inter] font-[500] text-[#FBFBFB]">
                    {holdersName}
                  </h1>
                </div>
              </div>
          ...
          <div>
            ...
            <p className="text-[14px] font-[400] font-[Open Sans] text-[#FBFBFB]/50">
        ...
        <div className="flex flex-col gap-[18px] w-full">
          <div className="flex flex-col gap-[18px] w-full">
            ...
            <div className=" rounded-[12px] w-full gap-[12px] flex justify-between p-[26px] ">
              <div className="flex flex-col gap-[16px]">
                <h1 className="opacity-50 text-[#FBFBFB]">Fees</h1>
                <div className="relative">
                  <button
                    type="button"
                    className="text-[#FBFBFB] opacity-50 items-center w-[100px] flex justify-between text-[21px] font-[600] font-[Montserrat] cursor-pointer "
                  >
                    Receive
                  </button>
                </div>
            ...
            <button
              type="button"
              className="w-full text-[16px] font-[600] font-[Open Sans] text-[#FBFBFB]/60 cursor-pointer bg-[#FBFBFB12]/20 rounded-[48px] gap-[8px] py-[21px] px-[22px] hover:bg-transparent "
            >
              Request Withdrawal
            </button>
          </div>
